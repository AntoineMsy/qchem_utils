...
from qchem_utils._src.system import PCMolecule
...
# LiH molecule
out_dir = '/leonardo_work/EUHPC_A05_006/NeurIS/qchem_utils/out_test/vit'
cid = 62714
...
lr_vmc = optax.linear_schedule(init_value=1e-2, transition_steps=n_iter_vmc, end_value=5e-3)
# lr_nis =  optax.linear_schedule(init_value=1e-2, transition_steps=n_iter_vmc, end_value=7e-3)
import advanced_drivers as advd
modulus_distribution = advd.driver.overdispersed_distribution(alpha=2.0) # we instantiate at alpha=1 for stability

optimizer_vmc = optax.sgd(learning_rate=lr_vmc)
driver =advd.driver.VMC_NG(hamiltonian=H, 
                            ...
                            linear_solver_fn=nk.optimizer.solver.pinv_smooth(rtol=1e-7),
