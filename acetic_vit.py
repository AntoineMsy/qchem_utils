...
# LiH molecule
out_dir = '/leonardo_work/EUHPC_A05_006/NeurIS/qchem_utils/out_acetic/vit'
cid = 176
...
# NIS distribution and sampler
model_q = nk.models.RBM(alpha=alpha, param_dtype=jnp.float64)
sampler_q = nk.sampler.MetropolisExchange(hilbert=hi, graph = system.graph)
q = nk.vqs.MCState(sampler=sampler_q, model=model_q, n_samples=n_samples, seed=seed, sampler_seed=sampler_seed)
...
sampler_p2 = nk.sampler.MetropolisExchange(hilbert=hi, graph = system.graph)
