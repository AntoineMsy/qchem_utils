...
# LiH molecule
out_dir = '/lus/home/CT5/cad17236/fvicentini/test_antoine/qchem_utils/out_test/mlp'
cid = 62714

out_path = os.path.join(out_dir, str(cid))
os.makedirs(out_path, exist_ok=True)
mol, mo_coeff, mf = PCMolecule.molecule_cached(cid=cid, 
                                               dir='/lus/home/CT5/cad17236/fvicentini/test_antoine/qchem_utils/pubchem_cache', 
                                               basis="STO-3G")#62714)
